        ...
        <div class="card p-4 h-100 bg-primary-subtle">
          ...
          <div class="card-body">
            ...
            <ol class="px-3">
              ...
              <li>${
                justData.features && justData.features[2] !== undefined
                  ? justData.features[2]
                  : "No data found"
              }</li>
            </ol>
            ...
            <div class= 'row d-flex'>
              <div class="col-8 col-lg-9" >
                ...
                <p class="mt-3"><i class="fa-regular fa-calendar-days pe-2"></i> ${
                  justData.published_in
                }</p>
              </div>
              <div class="col-4 col-lg-3 my-auto">
                <button  data-bs-target="#staticBackdrop" data-bs-toggle="modal" class="btn border-0" id="card-btn" onclick = "universeDetails('${
                  justData.id
                }')"  ><i class="fa-solid fa-arrow-right text-danger bg-danger bg-opacity-10 p-3 rounded-circle"></i></button>
              </div>
            </div>
          </div>
        </div>
  ...
  modalContainer.innerHTML = `
    ...
    <div class="col-12 col-lg-5  p-4 " id="modal-left-container">
     ...
     <!-- 1st line section End -->
        ...
        <p class="text-center  w-100  h-75 px-3 py-3 mt-3  fw-bold" id='cost-box1'> ${
          details.pricing ? details.pricing[0].price : "No data"
        }  ${details.pricing ? details.pricing[0].plan : "no data"}</p> 

    </div>
    
    <div class="p-2 col-12 col-lg-4">
        <p class="text-center   w-100 h-75 px-3 py-3 mt-3 fw-bold" id='cost-box2'> ${
          details.pricing ? details.pricing[1].price : "No data"
        }  ${details.pricing ? details.pricing[1].plan : "no data"}
            </p>
    </div>
   
    <div class="p-2 col-12 col-lg-4">
        <p class="text-center w-100 h-75 px-3 py-3 mt-3 fw-bold"id='cost-box3'>${
          details.pricing ? details.pricing[2].price : "No data"
        }  ${details.pricing ? details.pricing[2].plan : "no data "}</p>
    </div>
</div>
...
<!-- 3rd line section start -->
 ...
 <div class="row mt-3 p-1">
    ...
    <div class="col-12 col-lg-5">
        ...
        <ul class= "p-0">
    <li>${
      details.integrations && details.integrations[0] !== undefined
        ? details.integrations[0]
        : "no data found"
    }</li>
    <li>${
      details.integrations && details.integrations[1] !== undefined
        ? details.integrations[1]
        : "no data found"
    }</li>
    <li>${
      details.integrations && details.integrations[2] !== undefined
...
<!-- 3rd line section end -->
    ...
    <div class="col-12 col-lg-5  p-4 ms-3 "id="modal-right-container" >
        <div class="position-relative">
            ...
            <button class="btn btn-danger w-100"  style="display: ${
              details.accuracy && details.accuracy.score ? "block" : "none"
            }">
              ${
                details.accuracy && details.accuracy.score
